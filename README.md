# Projet de Plateforme Éducative Mobile
...
## Flux Utilisateur
1. L'utilisateur démarre l'application et voit la liste des cours disponibles.
2. En cliquant sur "En savoir plus", il est redirigé vers une page de détails pour en savoir plus sur le cours sélectionné.
3. La navigation permet de revenir en arrière ou d'explorer d'autres cours.

## Installation
Pour installer et exécuter l'application :
1. Clonez ce dépôt.
2. Installez les dépendances avec `npm install`.
3. Démarrez l'application avec `npm start` ou `expo start`.
